...
# 1. Extracts video IDs from source
# 2. Downloads video transcripts using the IDs
# 3. Transforms and cleans the transcript data
# 4. Generates text embeddings from the processed transcripts
